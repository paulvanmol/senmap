...
%shpcntnt(shapefilepath=&path/ShapefileSNG/&level/Carte_DRV_region.shp)

%shpimprt(shapefilepath=&path/ShapefileSNG/&level/Carte_DRV_region.shp,
			ID=&ID,
